...
MEDIA_URL = '/media/'
MEDIA_ROOT = Path(os.environ.get('MEDIA_ROOT', BASE_DIR / 'backend' / 'media'))
...
# Лимит на загрузку: 500 МБ
MAX_UPLOAD_MB = int(os.environ.get('MAX_UPLOAD_MB', '500'))
FILE_UPLOAD_MAX_MEMORY_SIZE = 8 * 1024 * 1024  # 8MB — остальное в tmp файлы
